...
namespace AskMe.Services
{
    ...
    public class SpeechSynthesize
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpeechSynthesize"/> class.
        /// </summary>
        public SpeechSynthesize()
        {
            ...
            authentication = new Authentication(Constants.CRISAuthenticationURL, Constants.CRISTTSKey);
        }
        ...
        public void SpeakAsync(CancellationToken cancellationToken, InputOptions inputOptions)
        {
            Debug.WriteLine(DateTime.Now.ToLongTimeString() + "- " + "'" + inputOptions.Text + "'" + " Speech to Text started...");
            if (string.IsNullOrWhiteSpace(authentication.GetAccessToken()))
                authentication.RenewAccessToken();

            inputOptions.AuthorizationToken = "Bearer " + authentication.GetAccessToken();
                    ...
                    async (responseMessage, token) =>
                    {
                        try
                        {
                            if (responseMessage.IsCompleted && responseMessage.Result != null && responseMessage.Result.IsSuccessStatusCode)
                            {
                                ...
                                Debug.WriteLine(DateTime.Now.ToLongTimeString() + "- " + "'" + inputOptions.Text + "'" + " converted into audio stream");
        ...
        public class InputOptions
        {
            ...
            public InputOptions()
            {
                ...
                this.VoiceName = Constants.VoiceName;
            ...
            public IEnumerable<KeyValuePair<string, string>> Headers
            {
                get
                {
                    ...
                    // Refer to the doc
                    //toReturn.Add(new KeyValuePair<string, string>("X-Search-AppId", "07D3234E49CE426DAA29772419F436CB"));
                    //// Refer to the doc
                    //toReturn.Add(new KeyValuePair<string, string>("X-Search-ClientID", "1ECFAE91408841A480F00935DC390961"));
                    // The software originating the request
                    toReturn.Add(new KeyValuePair<string, string>("User-Agent", "AskMe"));
